...
#' and a fixed final analysis
#'
#' For a given data set, this function can efficiently compute the results of the group-sequential multivariate one-sample
#' log-rank test for different durations of the accrual duration. This function is needed to efficiently estimate the power
#' of such trials for different sample sizes via simulation.
#'
